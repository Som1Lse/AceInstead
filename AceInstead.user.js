...
// @resource    require_js          https://gcc.godbolt.org/ext/requirejs/require.js
            ...
            return {
                ...
                'fromTextArea': function(el,options){
                    var r = {
                        ...
                        'setGutterMarker': function(){},//@todo: implement
                        'setOption': function(){},//no-op
                        'markText': function(){},//no-op
                        'setSelection': function(begin,end){
                            ...
                            this._editor.scrollToLine(begin.line,true,true,function(){});
                        },
